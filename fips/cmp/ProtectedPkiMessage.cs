...
namespace Org.BouncyCastle.Cmp
{
    ...
    public class ProtectedPkiMessage
    {
        ...
        public bool Verify(IVerifierFactory<IParameters<Algorithm>> verifierFactory)
        {
        ...
        private T Process<T>(IStreamCalculator<T> streamCalculator)
        {
            byte[] enc = createSequence();
