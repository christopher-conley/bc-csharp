...
namespace Org.BouncyCastle.Operators
{
    internal class Utils
    {
        ...
        internal static readonly IDictionary<DerObjectIdentifier, FipsShs.AuthenticationParameters> macParams = new Dictionary<DerObjectIdentifier, FipsShs.AuthenticationParameters>(
        );
        ...
        private static IDictionary<DerObjectIdentifier, DerObjectIdentifier> digestOidForAlgOid = new Dictionary<DerObjectIdentifier, DerObjectIdentifier>();
        ...
        static Utils()
        {
            ...
            macParams.Add(IanaObjectIdentifiers.HmacSha1, FipsShs.Sha1HMac);
            macParams.Add(PkcsObjectIdentifiers.IdHmacWithSha224, FipsShs.Sha224HMac);
            macParams.Add(PkcsObjectIdentifiers.IdHmacWithSha256, FipsShs.Sha256HMac);
            macParams.Add(PkcsObjectIdentifiers.IdHmacWithSha384, FipsShs.Sha384HMac);
            macParams.Add(PkcsObjectIdentifiers.IdHmacWithSha512, FipsShs.Sha512HMac);
        ...
        internal static DerObjectIdentifier DigestOidForSigOid(DerObjectIdentifier sigOid)
        {
            return digestOidForAlgOid[sigOid];
        }
