...
namespace Org.BouncyCastle.Operators
{
    public class PkixPbeEncryptorBuilder
    {
        ...
        private readonly DerObjectIdentifier keyEncAlgorithm;
        ...
        public PkixPbeEncryptorBuilder(DerObjectIdentifier keyEncAlgorithm)
            : this(PasswordConverter.UTF8, FipsShs.Sha384HMac, keyEncAlgorithm)
        {
        }
