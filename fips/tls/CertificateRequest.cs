...
namespace Org.BouncyCastle.Tls
{
    ...
    public sealed class CertificateRequest
    {
        ...
        /// <param name="certificateAuthorities">an <see cref="IList"/> of <see cref="X500Name"/>.</param>
        ...
        /// <returns>an <see cref="IList"/> of <see cref="X500Name"/>.</returns>
        ...
        public void Encode(TlsContext context, Stream output)
        {
            ...
            else
            {
                ...
                int totalLength = 0;
                foreach (X500Name certificateAuthority in m_certificateAuthorities)
                {
