        ...
        : TlsProtocol
    {
            ...
            HandshakeMessageInput clientHelloMessage)
        {
            ...
            if (null == m_tlsServerContext.ClientSupportedVersions)
            {
                ...
                m_tlsServerContext.SetClientSupportedVersions(clientVersion.DownTo(ProtocolVersion.TLSv10));
            }
            else
            {
            ...
            {
                IDictionary sessionServerExtensions = resumedSession
            ...
            {
                securityParameters.m_extendedMasterSecret = offeredExtendedMasterSecret
