...
namespace Org.BouncyCastle.Tls.Crypto.Impl.BC
{
        ...
        : TlsCredentialedDecryptor
    {
        ...
        protected readonly AsymmetricRsaPrivateKey m_privateKey;
            ...
            IAsymmetricPrivateKey privateKey)
        {
            ...
            this.m_privateKey = (AsymmetricRsaPrivateKey)privateKey;
        }
        ...
        public virtual TlsSecret Decrypt(TlsCryptoParameters cryptoParams, byte[] ciphertext)
        {
            ...
            return SafeDecryptPreMasterSecret(cryptoParams, m_privateKey, ciphertext);
        }
        ...
        protected virtual TlsSecret SafeDecryptPreMasterSecret(TlsCryptoParameters cryptoParams,
            AsymmetricRsaPrivateKey rsaServerPrivateKey, byte[] encryptedPreMasterSecret)
        {
            ...
            try
            {
                IPrivateKeyRsaService service = CryptoServicesRegistrar.CreateService(rsaServerPrivateKey,
                    m_crypto.SecureRandom);
                IKeyUnwrapper<Rsa.Pkcs1v15WrapParameters> decryptor = service.CreateKeyUnwrapper(Rsa.WrapPkcs1v15);
                M = decryptor.Unwrap(encryptedPreMasterSecret, 0, encryptedPreMasterSecret.Length).Collect();
            }
            catch (Exception)
            {
                /*
