...
namespace Org.BouncyCastle.Tls
{
    public abstract class TlsUtilities
    {
        ...
        private static IDictionary CreateCertSigAlgOids()
        {
            ...
            AddCertSigAlgOid(d, Core.BsiObjectIdentifiers.ecdsa_plain_SHA1, HashAlgorithm.sha1, SignatureAlgorithm.ecdsa);
            AddCertSigAlgOid(d, Core.BsiObjectIdentifiers.ecdsa_plain_SHA224, HashAlgorithm.sha224, SignatureAlgorithm.ecdsa);
            AddCertSigAlgOid(d, Core.BsiObjectIdentifiers.ecdsa_plain_SHA256, HashAlgorithm.sha256, SignatureAlgorithm.ecdsa);
            AddCertSigAlgOid(d, Core.BsiObjectIdentifiers.ecdsa_plain_SHA384, HashAlgorithm.sha384, SignatureAlgorithm.ecdsa);
            AddCertSigAlgOid(d, Core.BsiObjectIdentifiers.ecdsa_plain_SHA512, HashAlgorithm.sha512, SignatureAlgorithm.ecdsa);
        ...
        public static bool IsSupportedCipherSuite(TlsCrypto crypto, int cipherSuite)
        {
            ...
            // TODO[tls-fips] Need cryptographic module nonce generator before TLS 1.3
            switch (encryptionAlgorithm)
            {
            case EncryptionAlgorithm.AES_128_GCM:
            case EncryptionAlgorithm.AES_256_GCM:
            ...
            case EncryptionAlgorithm.CAMELLIA_256_GCM:
            case EncryptionAlgorithm.SM4_GCM:
                return KeyExchangeAlgorithm.NULL == keyExchangeAlgorithm;
            ...
            IDictionary clientExtensions)
        {
            ...
            IDictionary clientAgreements = Core.Platform.CreateHashtable(3);
            ...
            IDictionary clientExtensions, int keyShareGroup)
        {
            ...
            IDictionary clientAgreements = Core.Platform.CreateHashtable(1);
            ...
            Stream output)
        {
            ...
            WriteOpaque16(encryptedPreMasterSecret, output);
