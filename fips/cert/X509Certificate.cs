...
namespace Org.BouncyCastle.Cert
{
        ...
        : X509ExtensionBase
    {
        ...
        private IAsymmetricPublicKey publicKeyValue;
        ...
        [Obsolete("Use 'CertificateStructure' property instead")]
...
//        public IPrincipal SubjectDN
        ...
        {
            get { return c.SubjectPublicKeyInfo; }
        }
		...
		public virtual IAsymmetricPublicKey GetPublicKey()
		{
            ...
            IAsymmetricPublicKey temp = AsymmetricKeyFactory.CreatePublicKey(c.SubjectPublicKeyInfo.GetEncoded());
