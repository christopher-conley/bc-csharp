...
namespace Org.BouncyCastle.Crmf
{
    public class CertificateRequestMessageBuilder
    {
        ...
        private ISignatureFactory<AlgorithmIdentifier> _popSigner;
        ...
        {
            _templateBuilder.SetValidity( new CrmfOptionalValidity(notBefore,notAfter).AsOptionalValidity());
            return this;
        }
        ...
        public CertificateRequestMessageBuilder SetProofOfPossessionSignKeySigner(ISignatureFactory<AlgorithmIdentifier> popoSignatureFactory)
        {
