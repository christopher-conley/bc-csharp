...
namespace Org.BouncyCastle.Crmf
{
    public class CertificateRequestMessage
    {
        ...
        public bool IsValidSigningKeyPop(IVerifierFactoryProvider<AlgorithmIdentifier> verifierProvider)
        {
            ProofOfPossession pop = certReqMsg.Popo;
            if (pop.Type == popSigningKey)
            {
        ...
        private bool verifySignature(IVerifierFactoryProvider<AlgorithmIdentifier> verifierFactoryProvider, PopoSigningKey signKey)
        {
            IVerifierFactory<AlgorithmIdentifier> verifer;
