...
namespace Org.BouncyCastle.Crmf
{
    public class ProofOfPossessionSigningKeyBuilder
    {
        ...
        {
            IMacFactory<AlgorithmIdentifier> fact = generator.Build(password);
        ...
        public PopoSigningKey build(ISignatureFactory<AlgorithmIdentifier> signer)
        {
            ...
            return new PopoSigningKey(popo, (AlgorithmIdentifier)signer.AlgorithmDetails, new DerBitString(result.Collect()));
        }
    }
}