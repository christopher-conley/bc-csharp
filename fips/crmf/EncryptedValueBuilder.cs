...
namespace Org.BouncyCastle.Crmf
{
    ...
    {
        private IKeyWrapper<AlgorithmIdentifier> wrapper;
        private ICipherBuilderWithKey<AlgorithmIdentifier> encryptor;
        ...
        ///
        public EncryptedValueBuilder(IKeyWrapper<AlgorithmIdentifier> wrapper, ICipherBuilderWithKey<AlgorithmIdentifier> encryptor) : this(wrapper, encryptor, null)
        {
        }
        ...
        ///
        public EncryptedValueBuilder(IKeyWrapper<AlgorithmIdentifier> wrapper, ICipherBuilderWithKey<AlgorithmIdentifier> encryptor, IEncryptedValuePadder padder)
        {
        ...
        public EncryptedValue Build(PrivateKeyInfo privateKeyInfo)
        {
            ...
            try
            {
                ...
                encSymmKey = new DerBitString(wrapper.Wrap(encryptor.Key.GetKeyBytes()).Collect());
