...
namespace Org.BouncyCastle.Crmf
{
    ...
    {
        private readonly CmsEnvelopedDataGenerator envGen;
        private readonly CmsProcessableByteArray keyContent;
        ...
        public PkiArchiveControlBuilder AddRecipientGenerator(IRecipientInfoGenerator recipientGen)
        {
        ...
        public PkiArchiveControl Build(ICipherBuilderWithKey<AlgorithmIdentifier> contentEncryptor)
        {
            CmsEnvelopedData envContent = envGen.generate(keyContent, contentEncryptor);
            EnvelopedData envD = EnvelopedData.GetInstance(envContent.ToAsn1Structure().Content);
