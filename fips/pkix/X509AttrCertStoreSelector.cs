...
{
    public class X509AttrCertStoreSelector:IClonableSelector<X509V2AttributeCertificate>
    {// TODO: name constraints???
        ...
        public bool Match(
            X509V2AttributeCertificate obj)
        {
            if (obj == null)
                throw new ArgumentNullException("obj");

            X509V2AttributeCertificate attrCert = obj as X509V2AttributeCertificate;
            ...
            {         
                Asn1OctetString targetInfoExt = Asn1OctetString.GetInstance(attrCert.GetExtensionValue(
                ...
                if (targetInfoExt != null)
                {
                    ...
                    try
                    {
                        targetinfo = TargetInformation.GetInstance(Asn1Object.FromByteArray(targetInfoExt.GetOctets())); // May not correct.
        ...
        public ISelector<X509V2AttributeCertificate> Clone()
        {
		...
		*/
        ...
        private ISet<GeneralName> ExtractGeneralNames(
            IEnumerable names)
        {
            ISet<GeneralName> result = new HashSet<GeneralName>();
            ...
            if (names != null)
            {
                foreach (object o in names)
                {
                    //if (o is GeneralName)
                    //{
                    //    result.Add((GeneralName)o);
                    //}
                    //else
                    //{

                    // Deals with o being GeneralName, byte[] or Asn1Sequence.
                    result.Add(GeneralName.GetInstance(o)); //Asn1Object.FromByteArray((byte[])o)));
                    //}
                }
            }
