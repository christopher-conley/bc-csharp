...
namespace Org.BouncyCastle.Pkix
{
    ...
    //		: ICertPathParameters
    {
		...
		*/
        ...
        private ISelector<X509Certificate> certSelector;
        private IList<IStore<X509Certificate>> stores;
        private ISelector<X509Certificate> selector;
        private bool additionalLocationsEnabled;
        private IList<IStore<X509Crl>> crlStores;
            ...
            ISet<TrustAnchor> trustAnchors)
        {
            ...
            this.certPathCheckers = new List<PkixCertPathChecker>();
            this.stores = new List<IStore<X509Certificate>>();
            this.crlStores = new List<IStore<X509Crl>>();
		...
		*/
        public virtual ISelector<X509Certificate> GetTargetCertConstraints()
        {
            ...
            IClonableSelector<X509Certificate> selector = certSelector as IClonableSelector<X509Certificate>;
            if (selector != null)
            {
                return selector.Clone();
            }
            throw new ArgumentException("selector is not cloneable selector.");

        
            //eturn (X509CertStoreSelector)certSelector.Clone();
        }
            ...
            ISelector<X509Certificate> selector)
        {
            ...
            {            
                IClonableSelector<X509Certificate> clonable = selector as IClonableSelector<X509Certificate>;

                if (clonable != null)
                {
                    certSelector = clonable.Clone();
                }
                else
                {
                    throw new ArgumentException("selector not ICloneableSelector");
                }
            }
        }
		...
		*/
        public virtual void SetCertPathCheckers(ICollection<PkixCertPathChecker> checkers)
        {
            certPathCheckers = new List<PkixCertPathChecker>();
            if (checkers != null)
            {
		 ...
		 */
        public virtual ICollection<PkixCertPathChecker> GetCertPathCheckers()
        {
            List<PkixCertPathChecker> checkers = new List<PkixCertPathChecker>();
		...
		*/
            ...
            PkixParameters parameters)
        {
            ...
            selector = parameters.selector == null ? null
                : ((IClonableSelector<X509Certificate>)parameters.selector).Clone();
            stores = new List<IStore<X509Certificate>>(parameters.stores);         
            crlStores = new List<IStore<X509Crl>>(parameters.crlStores);        
		...
		*/
        ...
        public virtual void SetCertStores(ICollection<IStore<X509Certificate>> stores)
        {
            ...
            {          
                this.stores =  new List<IStore<X509Certificate>>(stores);
            }
        }
		...
		* @see #getStores
		*/
        public virtual void AddCertStore(
            IStore<X509Certificate> store)
        {
            if (store != null)
            {
                stores.Add(store);
        ...
        public virtual void AddCrlStore(IStore<X509Crl> crl)
        {
            crlStores.Add(crl);
        }
        ...
        public virtual ICollection<IStore<X509Crl>> GetCrlStores()
        {
            return new UnmodifiableListProxy<IStore<X509Crl>>(crlStores);
        }
		...
		* @see #setStores(IList)
		*/
        public virtual ICollection<IStore<X509Certificate>> GetCertStores()
        {
            return new List<IStore<X509Certificate>>(stores);
        }
		...
		*/
        public virtual ISelector<X509Certificate> GetTargetConstraints()
        {
            if (selector != null)
            {
                return ((IClonableSelector<X509Certificate>)selector).Clone();
            }
            else
            {
                return null;
		...
		* @see X509AttributeCertStoreSelector
		*/
        public virtual void SetTargetConstraints(ISelector<X509Certificate> selector)
        {
            if (selector != null)
            {
                // TODO interface 
                this.selector =  ((IClonableSelector<X509Certificate>)selector).Clone();
            }
            else
            {
                this.selector = null;
		...
		*/
            ...
            ISet<TrustAnchor> trustedACIssuers)
        {
            ...
            {
                //foreach (TrustAnchor obj in trustedACIssuers)
                //{-
