...
namespace Org.BouncyCastle.Pkix
{
    ...
    {
        private readonly IAsymmetricKey pubKey;
        private readonly string caName;
        private readonly X500Name caPrincipal;
        ...
        /// </exception>
        public TrustAnchor(
            X500Name caPrincipal,
            IAsymmetricKey pubKey,
            byte[] nameConstraints)
        {
            if (caPrincipal == null)
            ...
            byte[] nameConstraints)
        {
            ...
            this.caPrincipal = new X500Name(caName);
            this.pubKey = pubKey;
            this.caName = caName;
            this.trustedCert = null;
            setNameConstraints(nameConstraints);
        ...
        /// </summary>
        public IAsymmetricKey CAPublicKey
        {
