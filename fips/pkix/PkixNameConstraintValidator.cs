...
namespace Org.BouncyCastle.Pkix
{
    public class PkixNameConstraintValidator
    {
            ...
            Asn1Sequence subtree)
        {
            ...
            for (int j = 0; j < subtree.Count; ++j)
            {
                ...
                if (subtreeRdn.Count == 1 && dnsRdn.Count == 1
                    && SerialNumberOid.Equals(subtreeRdn.First.Type)
                    && SerialNumberOid.Equals(dnsRdn.First.Type))
                {
                    if (!Platform.StartsWith(dnsRdn.First.Value.ToString(), subtreeRdn.First.Value.ToString()))
                        return false;
                }
        ...
        //throws PkixNameConstraintValidatorException
        {
            ...
            IEnumerator<Asn1Sequence> it = permitted.GetEnumerator();
        ...
        {
            ISet<Asn1Sequence> intersect = new HashSet<Asn1Sequence>();
            for (IEnumerator it = dns.GetEnumerator(); it.MoveNext();)
            {
                ...
                {
                    IEnumerator<Asn1Sequence> _iter = permitted.GetEnumerator();
        ...
        private ISet<Asn1Sequence> UnionDN(ISet<Asn1Sequence> excluded, Asn1Sequence dn)
        {
            ...
            else
            {
                ...
                IEnumerator<Asn1Sequence> it = excluded.GetEnumerator();
                while (it.MoveNext())
                {
                    Asn1Sequence subtree = it.Current;
        ...
        {
            ISet<String> intersect = new HashSet<String>();
            for (IEnumerator<GeneralSubtree> it = emails.GetEnumerator(); it.MoveNext();)
            {
                ...
                {
                    IEnumerator<String> it2 = permitted.GetEnumerator();
                    while (it2.MoveNext())
                    {
        ...
        private ISet<String> UnionEmail(ISet<String> excluded, String email)
        {
            ...
            {
                ISet<String> union = new HashSet<string>();
        ...
        {
            ISet<byte[]> intersect = new HashSet<byte[]>();
            for (IEnumerator it = ips.GetEnumerator(); it.MoveNext();)
            {
                ...
                else
                {
                    ...
                    while (it2.MoveNext())
                    {
                        ...
                        cpy(intersect, IntersectIPRange(_permitted, ip));
        ...
        private ISet<byte[]> UnionIP(ISet<byte[]> excluded, byte[] ip)
        {
            ...
            else
            {
                ...
                IEnumerator<byte[]> it = excluded.GetEnumerator();
                while (it.MoveNext())
                {
                    byte[] _excluded = (byte[])it.Current;
                 
                    cpy<byte[]>(union, UnionIPRange(_excluded, ip));
        ...
        {
            IEnumerator<T> ctr = from.GetEnumerator();
            while (ctr.MoveNext())
            {
                to.Add(ctr.Current);
            }
        ...
        {
            ISet<byte[]> set = new HashSet<byte[]>();
        ...
        private bool EmailIsConstrained(String email, String constraint)
        {
            ...
            {
                if (PkixCertFunctions.ToUpperInvariant(sub).Equals(PkixCertFunctions.ToUpperInvariant(constraint)))
                {
                    return true;
                }
            }
        ...
        private bool WithinDomain(String testDomain, String domain)
        {
            ...
            if (PkixCertFunctions.StartsWith(tempDomain, "."))
            {
            ...
            for (int i = -1; i < domainParts.Length; i++)
            {
                ...
                else if (!PkixCertFunctions.EqualsIgnoreCase(testDomainParts[i + d], domainParts[i]))
                {
                    return false;
                }
            }
        ...
        //throws PkixNameConstraintValidatorException
        {
            ...
            IEnumerator<String> it = permitted.GetEnumerator();
            ...
            while (it.MoveNext())
            {
                ...
                if (WithinDomain(dns, str)
                    || PkixCertFunctions.ToUpperInvariant(dns).Equals(PkixCertFunctions.ToUpperInvariant(str)))
                {
                    return;
                }
            }
        ...
        //     throws PkixNameConstraintValidatorException
        {
            ...
            while (it.MoveNext())
            {
                ...
                if (WithinDomain(dns, str) || PkixCertFunctions.EqualsIgnoreCase(dns, str))
                {
                    throw new PkixNameConstraintValidatorException(
        ...
        private void unionEmail(String email1, String email2, ISet<String> union)
        {
            ...
            if (email1.IndexOf('@') != -1)
            {
                ...
                if (email2.IndexOf('@') != -1)
                {
                    if (PkixCertFunctions.EqualsIgnoreCase(email1, email2))
                    {
                        union.Add(email1);
                    }
                    else
                ...
                else if (PkixCertFunctions.StartsWith(email2, "."))
                {
                ...
                {
                    if (PkixCertFunctions.EqualsIgnoreCase(_sub, email2))
                    {
                        union.Add(email2);
                    }
                    else
            ...
            else if (PkixCertFunctions.StartsWith(email1, "."))
            {
                if (email2.IndexOf('@') != -1)
                {
                ...
                {
                    if (WithinDomain(email1, email2) || PkixCertFunctions.EqualsIgnoreCase(email1, email2))
                    {
                        union.Add(email2);
                    }
            ...
            else
            {
                ...
                {
                    String _sub = email2.Substring(email1.IndexOf('@') + 1);
                    if (PkixCertFunctions.EqualsIgnoreCase(_sub, email1))
                    {
                        union.Add(email1);
                    }
                    else
        ...
        private ISet<String> intersectDNS(ISet<String> permitted, ISet<GeneralSubtree> dnss)
        {
            ...
            for (IEnumerator it = dnss.GetEnumerator(); it.MoveNext();)
            {
                ...
                {
                    IEnumerator<String> _iter = permitted.GetEnumerator();
                    while (_iter.MoveNext())
                    {
        ...
        protected ISet<String> unionDNS(ISet<String> excluded, String dns)
        {
            ...
            else
            {
                ...
                IEnumerator<String> _iter = excluded.GetEnumerator();
                while (_iter.MoveNext())
                {
        ...
        private bool IsUriConstrained(String uri, String constraint)
        {
            ...
            // a host
            if (!PkixCertFunctions.StartsWith(constraint, "."))
            {
                if (PkixCertFunctions.EqualsIgnoreCase(host, constraint))
                {
                    return true;
                }
            }
        ...
        private static String ExtractHostFromURL(String url)
        {
            ...
            int idxOfSlashes = PkixCertFunctions.IndexOf(sub, "//");
            if (idxOfSlashes != -1)
            {
        ...
        {
            IDictionary<int, ISet<GeneralSubtree>> subtreesMap = new Dictionary<int, ISet<GeneralSubtree>>();
            ...
            for (IEnumerator e = permitted.GetEnumerator(); e.MoveNext();)
            {
                ...
                ((ISet<GeneralSubtree>)subtreesMap[tagNo]).Add(subtree);
            }

            for (System.Collections.Generic.IEnumerator<KeyValuePair <int, ISet<GeneralSubtree>>> it = subtreesMap.GetEnumerator(); it.MoveNext();)
            {
                KeyValuePair<int,ISet<GeneralSubtree>> entry = (KeyValuePair<int, ISet<GeneralSubtree>>)it.Current;
                ...
                switch ((int)entry.Key)
                {
                    case 1:
                        permittedSubtreesEmail = IntersectEmail(permittedSubtreesEmail,
                            (ISet<GeneralSubtree>)entry.Value);
                        break;
                    case 2:
        ...
        private String StringifyIPCollection(ISet<byte[]> ips)
        {
            String temp = "";
            temp += "[";
            for (IEnumerator<byte[]> it = ips.GetEnumerator(); it.MoveNext();)
            {
